...
// 🔥 Firestore Real-Time Listener for Ticker Messages & News
  ...
  return (
    <>
      <Head>
        <title>Brahmaputra Gurukul - Best Preschool in Assam</title>
        <meta name="description" content="Brahmaputra Gurukul is a premier preschool offering top-quality early education for young learners." />
        <meta name="keywords" content="preschool, Brahmaputra Gurukul, early education, learning, kids school" />
        <meta name="robots" content="index, follow" />

        {/* Open Graph Meta Tags (For Social Media Previews) */}
        <meta property="og:title" content="Brahmaputra Gurukul - Best Preschool in Assam" />
        <meta property="og:description" content="Enroll your child in our fun and interactive learning programs!" />
