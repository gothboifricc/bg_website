...
//     setAttendance(docSnap.exists() ? docSnap.data().daysPresent : 0);
//   };

//   const fetchMessages = async (userId: string) => {
//     const docRef = doc(db, "messages", userId);
//     const docSnap = await getDoc(docRef);
//     setMessages(docSnap.exists() ? docSnap.data().message : "No new messages.");
//   };

//   const fetchHomework = async (userId: string) => {
//     const docRef = doc(db, "homework", userId);
//     const docSnap = await getDoc(docRef);
//     setHomework(docSnap.exists() ? docSnap.data().task : "No pending homework.");
//   };
...
//           <button onClick={() => setShowReports(false)} className="bg-green-500 p-3 rounded-xl text-center">Dashboard</button>
//           <button onClick={() => setShowReports(true)} className="hover:bg-purple-500 p-3 rounded-xl text-center">Daily Reports</button>
//         </nav>
...
//                 <h2 className="text-xl font-bold">Rhymes</h2>
//                 <iframe
